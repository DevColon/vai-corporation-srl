<template>
  <footer class="bg-white dark:bg-gray-900 relative z-10 bg-white dark:bg-dark pt-20 pb-10 lg:pt-[120px] lg:pb-20">
    <div class="container mx-auto">
      <div class="flex flex-wrap -mx-4">
        <div class="w-full px-4 sm:w-2/3 lg:w-3/12">
          <div class="w-full mb-10">
            <a href="javascript:void(0)" class="mb-6 inline-block max-w-[160px]">
              <img src="/img/logo.png" alt="logo" class="max-w-full dark:hidden" />
            </a>
            ...
            <p class="flex items-center text-sm font-medium text-dark dark:text-white">
              <span class="mr-3 text-primary">
                <UIcon name="i-material-symbols-phone-in-talk" class="text-[20px]" />
              </span>
              <span>+1 (809) - 809 - 8009</span>
            </p>
          </div>
        </div>
